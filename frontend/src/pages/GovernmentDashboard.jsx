...
|--------------------------------------------------------------------------
|
| Report.status is the source of truth for the report lifecycle.
|
| DRAFT
| SUBMITTED
| UNDER_REVIEW
...
| REJECTED
|
| GovernmentReportAssignment is NOT treated as a Report status.
|--------------------------------------------------------------------------
*/
...
export default function GovernmentDashboard() {
  ...
  */
  ...
  const summary = data?.summary || EMPTY_OBJECT;
  const government = data?.government || EMPTY_OBJECT;
  const recentReports = data?.recentReports || EMPTY_ARRAY;
  ...
  |--------------------------------------------------------------------------
  |
  | These cards are based on Report.status.
  |
  | Assignment determines which reports belong to the Government office.
  | Report.status determines the lifecycle state.
  |--------------------------------------------------------------------------
  */
        ...
        {error && (
          <div className="flex flex-col gap-3 rounded-2xl border border-red-200 bg-red-50 p-4 text-sm text-red-700 sm:flex-row sm:items-center sm:justify-between">
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 rounded-lg bg-red-600 px-3 py-2 text-xs font-bold text-white transition hover:bg-red-700"
            >
              <RefreshCw size={14} />
            ...
            <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
              ...
              <div>
                ...
                <p className="mt-2 max-w-2xl text-sm leading-6 text-emerald-50">
                  Monitor, review and coordinate civic
                  problems reported by citizens in your
                  jurisdiction.
                </p>
              ...
              <div className="mb-4 flex items-center justify-between">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-slate-500">
                    Current report workload and resolution
                    status
                  </p>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-xs text-slate-500">
                      Latest citizen reports routed to your
                      office
                    </p>
              ...
              <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                ...
                <div className="mt-5 space-y-3">
                  ...
                  <QuickAction
                    ...
                    description="Verified problems"
                    onClick={() =>
                      navigate(
                        "/government/reports?status=VERIFIED"
                      )
                    }
                  />
